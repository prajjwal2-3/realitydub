...
export default function Howitworks() {
  return (
    <div className='py-24 px-48 gap-12 flex flex-col  justify-center items-center'>
      ...
      <p className='text-xl w-8/12'>This workflow provides a streamlined and user-friendly experience for converting videos into different languages using AI dubbing technology.</p>
      </section>
      <section className='flex justify-evenly'>
        <div className="rounded-3xl w-3/12 p-7 bg-[#EBF4FC] gap-5 flex flex-col">
